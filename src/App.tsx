    ...
    <MainLayout>
      {(activeTab) => {
        switch (activeTab) {
          ...
          case 'hardware': return <Hardware state={state} />;
          case 'tools': return <Tools state={state} />;
          case 'accounts': return <Accounts state={state} />;
          case 'employees': return <Employees state={state} />;
          case 'vault': return <Vault state={state} />;
