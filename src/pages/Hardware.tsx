...
export const Hardware = ({ state }: { state: ReturnType<typeof useSystemState> }) => {
  ...
  const handleAdd = () => {
    addHardware({
      name: newName || 'New Asset',
      serialNumber: newSerial || 'SN-' + Math.floor(Math.random()*1000),
      type: newType,
      status: 'Available',
      notes: ''
    });
        ...
        {isAddMode ? (
          <div className="space-y-4">
             ...
             <div className="flex gap-3 pt-4">
               ...
               <Button className="flex-1" onClick={handleAdd}>Create Asset</Button>
             </div>
          </div>
        ) : selectedAsset ? (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <CredentialField label="Device Password" value={selectedAsset.credentials?.password || 'No password set'} />
            </div>
